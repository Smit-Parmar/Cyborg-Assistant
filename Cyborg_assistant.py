...
import smtplib
import googlesearch
name="Email@gmail.com"  #Your EmailID
...
def takeCommand(): #To recognize audio and convert it into string
        r=sr.Recognizer()
...
if __name__=="__main__":
    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            speak(f"Sir the time is {strTime}")
                ...
                try:
                    ...
                    print(name)
                    if "Friendname" in name:
                        to="Friendemail@gmail.com"
                        sendEmail(to,content)
                        speak("Email has been send sir")
                    elif "Frienname2" in name:
                        print(name)
                        to="Friend2email.@gmail.com"
                        sendEmail(to,content)        
                        speak("Email has been send sir")
                    else:
        ...
        elif "play apex" or "open apex legends" or "open apex" in query:
            codepath="C:\\ProgramData\\Microsoft\\Windows\\Start Menu\Programs\\Apex Legends"
            os.startfile(codepath)
